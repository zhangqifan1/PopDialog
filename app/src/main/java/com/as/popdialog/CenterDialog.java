...
public abstract class CenterDialog<T extends CenterDialog<T>> extends Dialog {
    /**
     * mTag(日志)
     */
    private String mTag;
     ...
     */
    private LinearLayout mLlControlHeight;
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout mLlTop = new LinearLayout(mContext);
        mLlTop.setGravity(Gravity.CENTER_HORIZONTAL|Gravity.CENTER_VERTICAL);
